...
<sec:authorize access="isAnonymous()">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a href="${pageContext.request.contextPath}/auth/facebook"><button class="btn btn-facebook"><i class="fa fa-facebook"></i> | <spring:message code="label.facebook.sign.in.button"/></button></a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <a href="${pageContext.request.contextPath}/auth/linkedin"><button class="btn btn-linkedin"><i class="fa fa-linkedin"></i> | <spring:message code="label.linkedin.sign.in.button"/></button></a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <%--<a href="${pageContext.request.contextPath}/auth/google">--%>
                        <%--<button class="btn btn-google-plus"><i class="fa fa-google-plus"></i> | <spring:message code="label.google.sign.in.button"/>--%>
                        <%--</button>--%>
                    <%--</a>--%>
                ...
                <form action="${pageContext.request.contextPath}/auth/google" method="post">
                    ...
                    <input type="hidden" name="scope" value="email https://www.googleapis.com/auth/plus.login https://www.googleapis.com/auth/plus.me https://www.googleapis.com/auth/tasks https://www.googleapis.com/auth/plus.stream.write https://www.googleapis.com/auth/plus.stream.read https://www.googleapis.com/auth/plus.moments.write" />
                </form>
                </div>
            </div>
        </div>
